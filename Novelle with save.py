...
while act != "Выход" or act != "выход" or kromer != 10000:
    ...
    print("Если хотите удалить прошлое сохранение введите симовл \"d\", если не хотиите то просто нажмите Enter")
    deli = input()
    if deli == "d":
        stats = 0
        kromer = 0
    ...
    if act == "3":
        ...
        stats = [15, 0, 15]
    skip = input()
    print("Если хотите использовать сохранение нажмите \"s\" а если не хотите просто нажмите Enter")
    using = input()
    if using == "s":
    ...
    while kromer != 10000:
        if kromer != 10000:
            ...
            if kromer >= 10000:
                ...
                print(stats, kromer)
                dat = {"infolist": infoList, "stats": stats, "kromer": kromer}
